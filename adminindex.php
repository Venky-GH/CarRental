...
<nav class="nav navbar-nav navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="adminindex.php">Welcome to Carrental</a></div>
...
<div id="container">
    ...
    <br><br><
    <div id="footer">
        <p style="color:#4C4646;padding-left:640px">
            Copyright : Designed by V Sanjay Deva Rao and Venkatesh Naidu
        </p>
    </div>
    <!-- end #footer -->
</div>
